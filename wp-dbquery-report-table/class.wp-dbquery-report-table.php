...
class DBQuery_Report_Table
{
    ...
    public static function dbquery_report_table_form()
    {
        ...
        echo '<span class="form-header"><button class="back"><a href="' . esc_url(admin_url("admin.php?page=dbquery-report-table")) . '"><</a></button><h2>Edit DBQuery Report Table Form</h2></span>';
